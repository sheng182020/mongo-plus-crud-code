...
public class ResponseItemGenerator {
	...
	public static void cal(GenerateCode code) {
		...
		sb.append("\n")
				...
				.append("public class ").append(className).append("ItemResponse {\n")
				.append("\n")
		...
		sb.append("    public static ").append(className).append("ItemResponse toResponse(").append(className).append("Entity entity) {\n")
				.append("        if (entity == null) {\n            return null;\n        }\n")
				.append("        String json = JSONUtil.toJsonStr(entity);\n").append("        return JSONUtil.toBean(json, ")
				.append(className).append("ItemResponse.class);\n").append("    }\n");
		sb.append("}\n");

//		t.log(sb.toString());

		code.setResponseItemCode(sb.toString());
		code.setResponseItemCodeFileName(className + "ItemResponse.java");
	}
}
