...
public class RequestUpdateGenerator {
	...
	public static void cal(GenerateCode code) {
		...
		sb.append("\n")
				...
				.append("\n")
				.append("/**\n")
				.append(" * ").append(code.getTable().getTableComment()).append(" 修改参数 \n")
				.append(" *\n")
				.append(" */\n")
				.append("@Data\n")
				.append("@AllArgsConstructor\n")
				.append("@NoArgsConstructor\n")
				.append("public class ").append(className).append("UpdateRequest {\n\n")
		...
		sb.append("    public static ").append(className).append("Entity toEntity(").append(className).append("UpdateRequest request) {\n")
		...
		code.setRequestUpdateCode(sb.toString());
		code.setRequestUpdateCodeFileName(className + "UpdateRequest.java");
	}
