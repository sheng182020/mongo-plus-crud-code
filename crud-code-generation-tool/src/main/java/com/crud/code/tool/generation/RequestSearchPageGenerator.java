...
public class RequestSearchPageGenerator {
	...
	public static void cal(GenerateCode code) {
		...
		sb.append("\n")
				...
				.append("\n")
				.append("/**\n")
				.append(" * ").append(code.getTable().getTableComment()).append(" 分页查询参数 \n")
				.append(" *\n")
				.append(" */\n")
				.append("@Data\n")
				.append("@AllArgsConstructor\n")
				.append("@NoArgsConstructor\n")
				.append("public class ").append(className).append("SearchPageRequest extends BasePageRequest {\n\n")
		;
		...
		sb.append("    public static ").append(className).append("Entity toEntity(").append(className).append("SearchPageRequest request) {\n")
		...
		code.setRequestSearchPageCode(sb.toString());
		code.setRequestSearchPageCodeFileName(className + "SearchPageRequest.java");
	}
